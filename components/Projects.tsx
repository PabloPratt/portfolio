...
const projects = [
  {
    id: 1,
    title: 'Janus',
    description: 'Texas business intelligence & privacy SaaS. Search 3M+ TX businesses by ZIP, city, county. AI chat-powered lead generation + registered agent service ($149/yr).',
    tags: ['Next.js 16', 'TypeScript', 'Tailwind', 'Clerk', 'Stripe', 'Supabase', 'Gemini API'],
    live: 'https://janus-signalinput25-s-projects.vercel.app',
  ...
  },
  {
    ...
    description: 'Real-time stock screener ranking companies by analyst sentiment and earnings beat probability. Live leaderboard of high-potential earnings plays.',
    tags: ['Next.js', 'React', 'UnusualWhales API', 'Real-time Data', 'TradingView'],
    live: 'https://earnings-radar.vercel.app',
    github: 'https://github.com/PabloPratt/earnings-radar',
    featured: true,
  },
  {
    id: 3,
    title: 'EMDR-BLS',
    description: 'Bilateral Stimulation therapy tool using moving dots, audio tones, and imagery to support EMDR (Eye Movement Desensitization and Reprocessing) therapy.',
    tags: ['Next.js 16', 'React', 'Web Audio API', 'Canvas', 'Accessibility First'],
